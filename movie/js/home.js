...
function base64decode(str){
	...
	do{c3=str.charCodeAt(i++)&0xff;
		...
		do{c4=str.charCodeAt(i++)&0xff;if(c4==61)return out;
...
function utf16to8(str){
	...
	for(i=0;i<len;i++){c=str.charCodeAt(i);
		...
		else if(c>0x07FF){out+=String.fromCharCode(0xE0|((c>>12)&0x0F));
			out+=String.fromCharCode(0x80|((c>>6)&0x3F));
			out+=String.fromCharCode(0x80|((c>>0)&0x3F))}
		else{out+=String.fromCharCode(0xC0|((c>>6)&0x1F));
...
var MAC={
	...
	'Fav': function(u,s){
		try{ window.external.addFavorite(u, s);}
			...
			try{window.sidebar.addPanel(s, u, "");}
